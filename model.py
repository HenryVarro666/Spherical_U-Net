...
class Unet_40k_batch_2(nn.Module):
    """Define the Spherical UNet structure
    ...
    def __init__(self, in_ch, out_ch1, out_ch2):
        ...
        Parameters:
            ...
            out_ch (int) - - output features/channels
        """
        super(Unet_40k_batch_2, self).__init__()
...
class Unet_40k_batch(nn.Module):
    """Define the Spherical UNet structure
    ...
    def __init__(self, in_ch, out_ch):
        ...
        Parameters:
            ...
            out_ch (int) - - output features/channels
        """
        super(Unet_40k_batch, self).__init__()
